...
class CalculatorStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Mul = channel.unary_unary(
                ...
                _registered_method=True)
        self.BigThree = channel.unary_unary(
                '/Calculator/BigThree',
                request_serializer=calculator__pb2.BigThreeRequest.SerializeToString,
                response_deserializer=calculator__pb2.BigThreeReply.FromString,
                _registered_method=True)
...
class CalculatorServicer(object):
    ...
    def BigThree(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_CalculatorServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'BigThree': grpc.unary_unary_rpc_method_handler(
                    servicer.BigThree,
                    request_deserializer=calculator__pb2.BigThreeRequest.FromString,
                    response_serializer=calculator__pb2.BigThreeReply.SerializeToString,
            ),
...
class Calculator(object):
    ...
    def BigThree(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/Calculator/BigThree',
            calculator__pb2.BigThreeRequest.SerializeToString,
            calculator__pb2.BigThreeReply.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
